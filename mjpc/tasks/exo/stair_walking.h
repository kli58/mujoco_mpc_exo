...
#ifndef MJPC_TASKS_EXO_STAIR_WALK_TASK_H_
#define MJPC_TASKS_EXO_STAIR_WALK_TASK_H_
...
class stair_walking : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    ...
    explicit ResidualFn(const stair_walking* task) : mjpc::BaseResidualFn(task) {loadGoalJtPosition();}
  ...
  stair_walking() : residual_(this) {loadGoalJtPosition();};
